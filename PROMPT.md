...
## [v0.8.4] README Vercel 배포 반영
- **요청 목적**: Vercel 배포·확인 완료에 맞춰 README의 배포·실행·보완 기록을 갱신하기 위함
- **사용된 프롬프트 원본**:
  ```text
  리드미 자체에서 수정할 부분 있으면 수정해주세요. 확인은 제가 했습니다.
  ```

## [v0.8.6] README §17 기능 보완점으로 축약
- **요청 목적**: §17을 문서가 아닌 앱 기능 관점의 짧은 보완 계획으로 정리하기 위함
- **사용된 프롬프트 원본**:
  ```text
  너무 길어요. 짧게 그리고 기능적인 측면에서 적어주세요. 기록적인 측면 말고
  ```
